  ...
  <div class="relative flex w-full max-h-[600px] aspect-[4/3]">
    ...
    >
      ...
      <button
        ...
        :class="`md:w-[78px] md:h-auto relative shrink-0 pb-1 -mb-2 border-b-4 snap-start cursor-pointer focus-visible:outline focus-visible:outline-offset transition-colors flex-grow md:flex-grow-0  ${
